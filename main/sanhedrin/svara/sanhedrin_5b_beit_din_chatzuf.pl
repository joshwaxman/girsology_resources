...
% --------------------------------------------------------------------
prop(p_din_shmuel_shnayim).
gloss(p_din_shmuel_shnayim, 'two who judged -- their judgment is a judgment, but they are called an impudent court').
locus(p_din_shmuel_shnayim, 'Sanhedrin.5b.12').
content(p_din_shmuel_shnayim, din_status(shnayim_shedanu, din_aval_chatzuf)).
prop(p_yosifu).
...
content(p_yosifu_objection, objection(din_shmuel_shnayim, mishnat_yosifu)).
prop(p_shani_hatam).
...
content(p_shmuel_kerabbanan, not_aligned(din_shmuel_shnayim, rsbg)).
...
% Sanhedrin.5b.12
commit(rava, objection(din_shmuel_shnayim, mishnat_yosifu), assert, actual).
% Sanhedrin.5b.13
...
% Sanhedrin.6a.1
commit(stam_5b, not_aligned(din_shmuel_shnayim, rsbg), assert, actual).
...
commit(r_meir, size(beit_din_pshara, shlosha), assert, actual).
% Sanhedrin.6a.6
commit(chachamim, size(beit_din_pshara, echad), assert, actual).
% Sanhedrin.6a.6
